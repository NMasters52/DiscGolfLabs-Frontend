  ...
  return (
    ...
    >
      <Link to="#" className="block h-full">
        <Card className="relative h-full overflow-hidden hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300">
          <DiscGolfLabBackground variant="training" density={16} />
